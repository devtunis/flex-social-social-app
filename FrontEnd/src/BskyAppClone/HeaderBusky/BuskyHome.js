...
import { Tabs, TabList, TabPanels, Tab, TabPanel, Divider, Box, Avatar, CircularProgress, EnvironmentProvider, useEventListener } from '@chakra-ui/react'
...
{fetchPostsFromDataBase
  ...
  .map((index) => <Posts item={index} key={index.id}  updateMessage  ={updatePost} />)
...
<div className='SectionCurrentPost'>
  ...
  <div className='containerAppF'>
    ...
    <div className='shareButtonS'>   <input type='text' placeholder='Share your thoughts' value={dataFromPostComeent}
    onChange={(e)=>setdataFromPostComeent(e.target.value)}
    /></div>

     <div className='buttonPost'>
     <button onClick={()=>PostCommentA()}>Post</button>
     </div>
...
<div className='userInfoCardComment' style={{marginLeft:"40px"}}>
