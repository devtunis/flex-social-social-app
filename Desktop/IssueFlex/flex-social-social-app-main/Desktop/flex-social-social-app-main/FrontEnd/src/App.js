...
import HandelVideoCall from './ReallChat/HandelVideoCall.js';
import WaitingCall from './ReallChat/WaitingCall.js';
      ...
      {online === false ? (
        ...
        <>
          <Routes>
            ...
            <Route path='/videoCall' element={<><HandelVideoCall/></>} />
            <Route path='/waitingCall/:id' element={<><WaitingCall/></>} />
